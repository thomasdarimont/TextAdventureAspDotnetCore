    ...
    public DemoStory()
    {
        var nodes = new List<StoryNode>
        {
            new StoryNode
            {
                ...
                {
                    new Choice { Text = "Take the left path", Keyword="left", NextNodeId = "Chapter1_Act1_Scene1_C1" },
                    new Choice { Text = "Take the right path", Keyword="right", NextNodeId = "Chapter1_Act1_Scene1_C2" },
                }
            },
            ...
            new StoryNode
            {
                ...
                Choices = new List<Choice>
                {
                    new Choice { Text = "Swim across the river", Keyword = "swim", NextNodeId = "Chapter1_Act1_Scene2_C1" },
                    new Choice { Text = "Look for a bridge", Keyword = "bridge", NextNodeId = "Chapter1_Act1_Scene2_C2" },
                }
            },
            new StoryNode
            {
                ...
                Choices = new List<Choice>
                {
                    new Choice { Text = "Climb a tree", Keyword = "climbTree", NextNodeId="..." },
                    new Choice { Text = "Try to scare the bear", Keyword = "scareBear", NextNodeId="..." },
                }
            },
            ...
            new StoryNode
            {
                ...
                Choices = new List<Choice>
                {
                    new Choice { Text = "Look at the flowers", Keyword = "look", NextNodeId="..." },
                    new Choice { Text = "Lay down and sleep", Keyword = "sleep", NextNodeId="..." },
                }
            },
            ...
            new StoryNode
            {
                ...
                Choices = new List<Choice>
                {
                    new Choice { Text = "Walk across the bridge", Keyword = "across", NextNodeId = "Chapter1_Act1_Scene3_C1" },
                    new Choice { Text = "Walk back", Keyword = "back", NextNodeId = "Chapter1_Act1_Scene1_C1" },
                }
            },
        ...
        this.storieNodes = nodes;
    }

    public StoryNode StartNode { get => storieNodes[0]; }
